...
const CATEGORIES = [
  {
    ...
    articles: [
      ...
      },
      {
        ...
        desc: 'The one-year suit limitation is not as simple as it appears. How equitable tolling pauses the clock while your insurer investigates.',
      ...
      },
      {
        ...
        desc: 'When a utility causes a wildfire, you may have a strict-liability claim beyond insurance. How inverse condemnation works in California.',
      ...
      },
      {
        ...
        desc: 'Your insurer must conduct a thorough, fair investigation. When they don\'t, it\'s bad faith — even if the claim might not have been covered.',
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        desc: 'More than just the dwelling — debris removal applies to other structures, trees, and personal property. The additional 5% provision and how to maximize recovery.',
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        desc: 'What PAs cost, how contingency fees work, California\'s disaster fee cap, when hiring a PA is worth it, and questions to ask before signing.',
      ...
      },
      {
        ...
        desc: 'How mediation works, when it resolves disputes faster and cheaper than litigation, and how to prepare for a strong outcome.',
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        desc: 'When your home is a complete loss — every coverage that activates, rebuilding vs. cashing out, contents claims, and California protections.',
      ...
      },
      {
        ...
        desc: 'The most common homeowner claim — causes, coverage, matching disputes, repair vs. replacement, and how to fight for full payment.',
      ...
      },
      {
        ...
        desc: 'Insurers increasingly deny "cosmetic" damage. Why this argument fails, what "direct physical loss" really means, and how to fight back.',
