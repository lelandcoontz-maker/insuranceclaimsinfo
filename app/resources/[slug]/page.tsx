...
const ARTICLE_META: Record<string, { title: string; description: string }> = {
  ...
  'cause-and-origin-fire-investigations': { title: 'Cause and Origin Investigations in Fire Claims: What Policyholders Need to Know', description: 'How cause and origin fire investigations work, the critical differences between fire department reports and insurance company investigators, NFPA 921 methodology, policyholder rights, and how to challenge a biased C&O report.' },
  ...
  'subrogation-insurance-claims': { title: 'Subrogation: How the Carrier\'s Recovery Rights Affect Your Claim', description: 'How your insurer\'s subrogation rights can affect your claim payment, why your duty to cooperate matters, the made-whole doctrine, deductible recovery, waiver of subrogation, and California-specific rules.' },
