...
const ARTICLE_META: Record<string, { title: string; description: string }> = {
  ...
  'biohazard-hazmat-trauma-cleanup': { title: 'Biohazard, Hazmat & Trauma Cleanup: The Insurance Coverage Gap Nobody Talks About', description: 'How insurance covers (or denies) biohazard and trauma cleanup after crime scenes, unattended deaths, meth contamination, hoarding, and sewage events.' },
  'unattended-death-claims': { title: 'Unattended Death Insurance Claims: What Families and Property Owners Need to Know', description: 'How insurance handles unattended death claims — decomposition damage, coverage analysis, common carrier denials, the pollution exclusion fight, and practical steps for families.' },
  ...
  'when-to-hire-attorney':  { title: 'When to Hire an Insurance Claim Attorney — And How Attorneys and Public Adjusters Work Together', description: 'Not every insurance claim needs a lawyer, but some absolutely do. Learn the fundamental difference between attorneys and Public Adjusters, when you need one or both, how their fees work, and how the PA-to-attorney pipeline maximizes your recovery.' },
  ...
  'biased-insurance-experts': { title: 'Biased Insurance Experts: How to Identify, Challenge, and Defeat the Insurer\'s Hired Professionals', description: 'Insurance companies hire engineers, hygienists, and estimators who consistently minimize claims. Learn how the repeat-player system works, how limited assignments pre-load the outcome, the confirmation bias feedback loop, and how to fight back — including licensing board complaints.' },
  ...
  'defeating-carrier-engineers': { title: 'Defeating Carrier Expert Reports: Engineers, Inspectors, and Hired Professionals', description: 'When your insurance company sends an engineer, hygienist, or other expert to minimize your claim, you need to know how to respond. Learn how carrier experts operate, common report flaws, license board complaints, and how to build a strong rebuttal.' },
  ...
  'stock-inventory-valuation-methods': { title: 'Stock & Inventory Valuation Methods in Commercial Property Insurance Claims', description: 'How ISO valuation methods determine whether your destroyed inventory is paid at cost, selling price, or finished goods value — and how to push back when the carrier cherry-picks the cheapest method to minimize your recovery.' },
  'business-income-loss-calculation': { title: 'Business Income Loss Calculation: How to Build and Defend Your BI Claim', description: 'A detailed guide to calculating business income losses under commercial property policies. Covers the but-for projection, net income plus continuing expenses formula, seasonal adjustments, growth trends, the CP 15 15 worksheet, and how to counter carrier forensic accountants who minimize your claim.' },
  ...
  'proof-of-loss-signing-strategy': { title: 'The Proof of Loss: What You Are Really Signing and How to Protect Yourself', description: 'A proof of loss is a sworn statement that can lock you into the carrier\'s numbers and waive coverages you didn\'t intend to surrender. Learn about partial proofs of loss, how to modify the carrier\'s form, state-by-state rules, and why NFIP flood claims demand special care.' },
  ...
  'insurer-directed-failed-repairs-wasted-policy-limits': { title: 'When the Insurance Company Burns Your Policy Limits on Repairs That Were Never Going to Work', description: 'When insurers direct policyholders to attempt cleaning or repairs the insured warned would fail, the wasted costs consume policy limits. Learn how to protect your benefits with test cleanings, trade standards, and proper documentation.' },
  ...
  'tortious-interference-insurance-claims': { title: 'Tortious Interference with Contractor Relationships in Insurance Claims', description: 'When a carrier or its preferred vendor pressures a homeowner to abandon their chosen contractor, it may constitute tortious interference with contractual relations under California law.' },
  'three-bids-myth': { title: 'The “Three Bids” Myth: Why Your Insurance Company Cannot Require Multiple Contractor Estimates', description: 'No standard homeowner\'s policy requires three bids before the carrier will pay. Learn where this demand actually comes from, why carriers use it, and how to respond.' },
  'esx-file-rights-xactimate': { title: 'Your Right to the Xactimate ESX File: Why the PDF Is Not Enough', description: 'A comprehensive guide for policyholders, public adjusters, and attorneys on why you should demand the native Xactimate ESX file and what critical estimate data the ESX file reveals that the PDF conceals.' },
  'desk-adjusting-remote-estimates': { title: 'Desk Adjusting: When Your Insurance Company Writes an Estimate Without Seeing the Damage', description: 'Insurance carriers increasingly use desk adjusters who write Xactimate estimates from photos or satellite imagery without ever visiting your property. Learn what gets missed and how to challenge a remote estimate.' },
  'xactimate-price-list-dates': { title: 'Xactimate Price List Dates: Why the Date on Your Estimate Matters More Than You Think', description: 'How insurance companies use outdated Xactimate price lists to systematically underpay claims. Learn where to find the price list date and how to challenge stale pricing.' },
  'scope-vs-price-disputes': { title: 'Scope vs. Price: The Two Disputes Your Insurance Company Hopes You\'ll Confuse', description: 'Every insurance claim dispute is either a scope dispute or a price dispute. Understanding which fight you are in changes your evidence, your strategy, and your path to resolution.' },
  'adjuster-changes-mid-claim': { title: 'When Your Adjuster Changes Mid-Claim: Why It Happens and What You Can Do', description: 'Adjuster reassignment mid-claim causes delays, lost context, and shifting coverage positions. Learn why carriers rotate adjusters and what rights you have under California law.' },
  ...
  'supplement-process-insurance-claims': { title: 'The Supplement Process: Why Your First Estimate Is Almost Never the Last', description: 'A comprehensive guide to insurance claim supplements — why they are normal, when they are needed, how carriers resist them, and documentation best practices.' },
  'labor-depreciation-debate': { title: 'Labor Depreciation: Can Labor "Wear Out"? The National Debate Over Depreciating Services', description: 'A comprehensive analysis of the labor depreciation debate in insurance claims. States are increasingly saying labor cannot physically deteriorate. Learn the case law, California\'s position, and how to challenge labor depreciation.' },
  'xactimate-line-item-manipulation': { title: 'Xactimate Line Item Manipulation: How "Included" Makes Covered Items Disappear', description: 'How insurance carriers manipulate Xactimate line items — from the "included" designation and wrong codes to minimum charge suppression and missing items — and how to challenge every tactic using Verisk\'s own documentation.' },
  'how-to-read-xactimate-estimate': { title: 'How to Read Your Xactimate Estimate: A Consumer-Friendly Line-by-Line Guide', description: 'Learn how to read and understand every section of your Xactimate insurance estimate, from the header and line items to the summary page, so you can spot missing items and underpayments.' },
  'emergency-mitigation-vendors': { title: 'Emergency Mitigation Vendors: When the First Responder Works for the Insurance Company', description: 'How carrier-dispatched mitigation vendors create conflicts of interest that shape the entire claim. Covers your right to choose your own vendor, inflated invoices, documentation control, and IICRC standards.' },
  'insurance-ai-automated-claims': { title: 'Insurance Company AI and Automated Claims Processing: When an Algorithm Decides Your Claim', description: 'How insurance companies use artificial intelligence and automated systems to process property damage claims, why AI-driven claims handling leads to systematic underpayment, and how to challenge algorithmic decisions.' },
  ...
  'delay-deny-defend-review': { title: 'Book Review: Delay, Deny, Defend by Jay M. Feinman', description: 'A detailed review of the book that exposed how insurance companies systematically deny legitimate claims. What it documents, what it means for property claims, and why every policyholder should read it.' },
  'good-hands-boxing-gloves-review': { title: 'Book Review: From Good Hands to Boxing Gloves by David Berardinelli', description: 'A detailed review of the book that exposed Allstate\'s McKinsey-driven Claims Core Process Redesign. What the internal documents reveal, how CCPR spread through the industry, and what it means for your claim.' },
  'ab-1642-claims-timeline': { title: 'AB 1642 and California Claims Handling Timelines: The Deadlines Your Insurer Must Meet', description: 'California law imposes strict deadlines on insurance companies for acknowledging, investigating, and resolving claims. AB 1642 and the California Insurance Code establish specific timelines that policyholders can enforce.' },
  'advance-payments-insurance-claims': { title: 'Advance Payments on Insurance Claims: Your Statutory Right to Receive Undisputed Amounts Now', description: 'California law requires insurers to pay undisputed claim amounts promptly, even while disputed portions are still being adjusted. Learn how to demand advance payments, avoid the full-and-final check trap, and protect your rights when accepting partial payments.' },
  'back-to-back-disasters': { title: 'Back-to-Back Disasters: Navigating Overlapping Claims When a Second Peril Strikes Before the First Is Resolved', description: 'When a second disaster strikes before the first claim is settled, policyholders face overlapping deductibles, concurrent causation disputes, and carrier arguments about pre-existing damage. Learn how to manage two claims simultaneously and protect your rights under California law.' },
  'below-the-deductible-strategies': { title: 'When a Claim Is Below the Deductible: Strategies for Capturing the Full Scope of Loss', description: 'How deductibles work in property claims, why carriers have incentives to keep estimates below the deductible, commonly missed items that push claims over the threshold, and when to hire a public adjuster for borderline claims.' },
  'blanket-vs-scheduled-personal-property': { title: 'Blanket vs. Scheduled Personal Property Coverage: When to Schedule and What You Risk If You Do Not', description: 'How blanket personal property coverage works under Coverage C, when scheduling individual items is necessary, the valuation differences between each approach, and California-specific strategies for adequate contents coverage.' },
  'builders-risk-insurance-claims': { title: 'Builder’s Risk Insurance Claims: Coverage for Properties Under Construction, Renovation Losses, and Common Disputes', description: 'Builder’s risk policies insure properties during construction or major renovation. Learn what these policies cover, how they differ from standard property insurance, and the most common claim disputes including faulty workmanship, soft costs, and delay in completion.' },
  'certificates-of-insurance-limitations': { title: 'Certificates of Insurance: What They Actually Prove and What They Do Not', description: 'A certificate of insurance is not a contract and does not guarantee coverage. Learn why relying on a COI can leave businesses, property owners, and contractors exposed, and what verification steps actually protect your interests.' },
  'commercial-crime-social-engineering': { title: 'Commercial Crime Insurance and Social Engineering Fraud: Closing the Coverage Gap', description: 'How commercial crime policies work, why standard coverage may not protect against social engineering and business email compromise losses, and what endorsements businesses need to close the gap.' },
  'depublication-hidden-insurance-law': { title: 'Depublication: How California Insurance Law Disappears', description: 'How the California Supreme Court\'s depublication power removes policyholder-favorable appellate opinions from the body of citable law, and why this little-known process matters for insurance claims disputes.' },
  'false-fraud-accusations-claims': { title: 'False Fraud Accusations in Insurance Claims: When Carriers Weaponize the SIU Process', description: 'How insurers use false or pretextual fraud accusations to deny legitimate claims, the Special Investigations Unit process, policyholder rights during fraud investigations, burden of proof requirements, and practical defense strategies under California law.' },
  'farmers-closing-ratio': { title: 'Closing Ratios: The Hidden Metric That May Be Driving Your Claim Outcome', description: 'How insurance company closing ratios create perverse incentives for adjusters to underpay claims, what California policyholders should watch for, and how to document potential adjuster bias.' },
  'fire-debris-cleanup-without-fire': { title: 'Fire Debris and Ash Contamination on Properties That Did Not Burn: Coverage, Cleanup, and the Cost Gap', description: 'When wildfire ash, soot, and toxic debris contaminate a property that was never on fire, policyholders face unique coverage challenges. Covers cleanup costs, pollution exclusion issues, DTSC programs, and how to document contamination claims in California.' },
  'fortuity-doctrine-insurance': { title: 'The Fortuity Doctrine in Insurance: When Carriers Claim Your Loss Was Not an Accident', description: 'The fortuity doctrine requires that a covered loss be accidental and unforeseen. Learn how insurance companies misuse the known loss doctrine, loss-in-progress doctrine, and pre-existing damage arguments to deny legitimate claims in California.' },
  'frozen-pipe-water-damage-claims': { title: 'Frozen Pipe and Cold Weather Water Damage Claims: Coverage, Exclusions, and Carrier Tactics', description: 'Frozen pipe claims involve unique coverage issues including the maintenance exclusion, vacancy provisions, heat maintenance arguments, and ensuing loss disputes. Learn how California mountain community homeowners and cold-climate policyholders can protect their claims.' },
  'insurer-antitrust-fair-plan': { title: 'Insurer Antitrust Concerns and the FAIR Plan: When Market Withdrawal Looks Coordinated', description: 'When major insurers simultaneously withdraw from California, the FAIR Plan becomes the insurer of last resort for millions. The pattern raises serious antitrust questions that policyholders and regulators should understand.' },
  'insurer-insolvency-guaranty-fund': { title: 'When Your Insurance Company Fails: The Guaranty Fund Safety Net and Its Limits', description: 'What happens when an insurance company becomes insolvent in California. How the California Insurance Guarantee Association (CIGA) works, the $500,000 cap, covered and non-covered claims, and how to protect yourself.' },
  'insurer-reformation-policy': { title: 'When Your Insurer Tries to Rewrite Your Policy After a Loss: The Doctrine of Reformation and Carrier Misuse', description: 'How insurance companies attempt to use the legal doctrine of reformation to reduce coverage after a loss has occurred. Covers mutual mistake claims, the high burden of proof, California case law, the distinction from rescission, and how policyholders can fight back.' },
  'multiple-insurers-same-loss': { title: 'Multiple Insurance Policies Covering the Same Loss: Other Insurance Clauses, Stacking, and Maximizing Recovery', description: 'When two or more insurance policies cover the same property loss, disputes over priority, contribution, and payment responsibility are common. Learn how other insurance clauses work, how California courts resolve conflicts, and how policyholders can maximize recovery from overlapping coverage.' },
  'osha-building-code-ordinance-coverage': { title: 'OSHA Requirements and Building Code Upgrades as Triggers for Ordinance or Law Coverage', description: 'When workplace safety regulations and building codes force upgrades during insured repairs, ordinance or law coverage should pay the additional costs. Learn how OSHA standards, Cal/OSHA requirements, and building code changes trigger coverage for increased construction costs.' },
  'property-held-in-trust-coverage': { title: 'Insurance Coverage When Property Is Held in a Trust', description: 'How holding property in a trust creates named insured problems, insurable interest complications, and claim handling disputes — and what policyholders can do to avoid coverage gaps.' },
  'reserve-reinsurance-discovery': { title: 'Discovering Claim Reserves and Reinsurance Arrangements in Insurance Litigation', description: 'How to obtain an insurer\'s internal claim reserves and reinsurance treaty information through discovery in California insurance litigation. Covers why reserves matter, privilege objections, case law on discoverability, and practical strategies for litigators.' },
  'state-farm-appraisal-trap': { title: 'Games Insurers Play: The Appraisal Trap', description: 'How some insurers use procedural objections, umpire selection disputes, and timing delays to undermine the appraisal process — and how policyholders can fight back under California law.' },
  'systematic-underinsurance-class-actions': { title: 'Systematic Underinsurance and Class Action Litigation Against Carriers', description: 'How insurers systematically undervalue properties at policy inception, leaving entire classes of policyholders underinsured when losses occur, and the class action litigation that has followed.' },
  'trade-secret-claims-manuals': { title: 'Insurance Companies Hiding Behind Trade Secrets: The Battle to Obtain Claims Handling Manuals in Litigation', description: 'Insurance carriers routinely claim their claims handling manuals and training materials are trade secrets to block discovery in litigation. Learn how California courts have addressed this objection and why these documents matter for policyholders.' },
  'underground-climate-change-subsidence': { title: 'Underground Climate Change and Subsidence: The Coverage Gap Beneath Your Foundation', description: 'How underground climate change is causing soil shrinkage and foundation damage across the country — and why the earth movement exclusion may leave policyholders without coverage for an emerging threat.' },
  'underinsurance-broker-liability': { title: 'Underinsured After a Loss? When Your Insurance Agent or Broker May Be Liable', description: 'When a policyholder discovers they are underinsured after a major loss, the insurance agent or broker who placed the coverage may bear liability for professional negligence. Learn about broker duties, the special relationship doctrine, statutes of limitations, and how to pursue an E&O claim in California.' },
  'virtual-inspections-remote-adjusting': { title: 'Virtual Inspections and Remote Adjusting: How Desk Claims Affect Your Payout', description: 'How the shift to virtual inspections, desk adjusting, and remote claim handling affects property insurance claim outcomes — and what policyholders can do to protect their interests.' },
  'wildfire-smoke-physical-loss': { title: 'Wildfire Smoke and "Direct Physical Loss": The Coverage Debate in California', description: 'When wildfire smoke infiltrates a home without flames ever reaching it, does the contamination constitute direct physical loss under a homeowner policy? California courts are split, but the science and the law favor policyholders.' },
  ...
  'hotel-hospitality-insurance-claims': { title: 'Hotel and Hospitality Insurance Claims: When Every Room Lost Is Revenue Gone', description: 'Hotels and hospitality businesses face unique insurance vulnerabilities from business income losses during renovation to bedbug closures, franchise requirements, and seasonal revenue challenges.' },
  'auto-repair-body-shop-insurance-claims': { title: 'Auto Repair and Body Shop Insurance Claims: Customer Vehicles, Paint Booth Fires, and Environmental Liability', description: 'Auto repair shops and body shops face unique insurance exposures from garage keeper\'s liability for customer vehicles to paint booth fires, environmental contamination, and equipment breakdown.' },
  'warehouse-distribution-insurance-claims': { title: 'Warehouse and Distribution Insurance Claims: When You\'re Holding Everyone Else\'s Property', description: 'Warehouse and distribution facilities face unique insurance challenges from bailee coverage for customer goods to spoilage, sprinkler requirements, and the coinsurance problem with fluctuating inventory.' },
  'construction-company-insurance-claims': { title: 'Construction Company Insurance Claims: Builder\'s Risk, Tools on the Job Site, and the CGL Boundary', description: 'Construction companies face overlapping and often conflicting insurance coverages. Learn how builder\'s risk, CGL, inland marine, and business income coverage interact — and where the gaps hide.' },
  'professional-services-insurance-claims': { title: 'Professional Services Firm Insurance Claims: Law Firms, Accounting Firms, and the Client Retention Crisis', description: 'Law firms, accounting firms, and architecture firms face unique property insurance challenges — from valuable papers and electronic data to the devastating client retention problem during closure.' },
  'extended-period-of-indemnity': { title: 'Extended Period of Indemnity: The Endorsement That Keeps Paying After You Reopen', description: 'When your business reopens after a loss but revenue is still far below pre-loss levels, the standard period of restoration has ended. The extended period of indemnity endorsement continues coverage for 30, 60, 90, or more days after operations resume.' },
  'dependent-property-business-income': { title: 'Business Income from Dependent Properties: When Someone Else\'s Loss Shuts Down Your Revenue', description: 'Dependent property business income coverage protects you when physical damage at a supplier, customer, manufacturer, or anchor business causes your revenue to drop. Learn the four ISO categories and the CP 15 08 endorsement.' },
  'ordinance-law-asbestos-abatement': { title: 'Ordinance or Law and Asbestos Abatement: Who Pays When a Covered Loss Triggers ACM Removal?', description: 'When a covered loss triggers demolition of a building containing asbestos-containing materials, who pays for the abatement? This article analyzes the intersection of ordinance or law coverage, the pollution exclusion, and the efficient proximate cause doctrine.' },
  'commercial-lease-insurance-checklist': { title: 'Insurance Requirements in Commercial Lease Negotiations: A Tenant\'s Checklist', description: 'A practical, actionable guide for commercial tenants reviewing and negotiating insurance provisions in their lease. Covers required coverages, red flags, what is negotiable, and a section-by-section markup guide.' },
  'landlord-insurance-should-have-covered': { title: 'When Your Landlord\'s Insurance Should Have Covered Your Loss', description: 'When a landlord\'s negligence causes damage to tenant property, the landlord\'s insurance should respond. Learn about subrogation, tender of defense, negligence per se, and practical steps tenants can take.' },
  'climate-change-commercial-property-insurance': { title: 'Climate Change and Commercial Property Insurance: What\'s Already Happening to Your Coverage', description: 'How climate change is already reshaping commercial property insurance through atmospheric rivers, extreme heat, wildfire smoke infiltration, post-wildfire debris flows, PSPS events, and the California insurance availability crisis.' },
  'parametric-insurance-commercial': { title: 'Parametric Insurance for Businesses: Fast Payouts When Traditional Coverage Falls Short', description: 'How parametric insurance works for commercial properties, including trigger-based payouts for earthquake, flood, wind, heat, and wildfire. Covers basis risk, regulatory treatment in California, pricing, and practical guidance.' },
  'commercial-umbrella-excess-liability': { title: 'Commercial Umbrella and Excess Liability Insurance: What Happens When Your Primary Policy Runs Out', description: 'Commercial umbrella and excess liability policies extend your coverage limits — but they are not the same thing. Learn the critical differences, the following form trap, drop-down coverage, self-insured retentions, and how to fight back when the umbrella carrier refuses to pay.' },
  'business-cyber-liability-insurance': { title: 'Cyber Liability Insurance for Businesses: The Coverage Your Property Policy Doesn\'t Provide', description: 'Traditional property and CGL policies exclude most cyber losses. Learn how cyber liability insurance works — first-party vs. third-party coverage, ransomware, social engineering fraud, the CGL boundary, CCPA exposure, and what California businesses need to know.' },
  'daycare-childcare-insurance-claims': { title: 'Daycare and Childcare Facility Insurance Claims: Licensing, Liability, and the Coverage Gaps That Close Programs', description: 'Daycare and childcare facilities face unique insurance vulnerabilities — licensing re-inspections that extend closures, abuse and molestation exclusions, parent retention during shutdown, and regulatory requirements that create coverage gaps.' },
  'coworking-space-insurance-claims': { title: 'Co-Working Space Insurance Claims: When 50 Businesses Share One Building and Nobody Knows Who\'s Covered', description: 'Who insures what when dozens of businesses share a co-working space? Understanding the three-layer insurance problem between building owners, co-working operators, and individual members.' },
  'food-truck-mobile-vendor-insurance-claims': { title: 'Food Truck and Mobile Vendor Insurance Claims: When Your Vehicle IS Your Business', description: 'Food trucks face a unique insurance challenge where commercial auto, commercial property, and general liability converge. Learn about the total loss problem, spoilage coverage, commissary requirements, and fire suppression.' },
  'manufacturing-industrial-insurance-claims': { title: 'Manufacturing and Industrial Facility Insurance Claims: Production Lines, Raw Materials, and the Bottleneck Problem', description: 'Manufacturing facilities face unique insurance challenges including raw materials vs. finished goods valuation, machinery breakdown bottlenecks, environmental contamination, OSHA compliance, and supply chain disruption.' },
  'church-nonprofit-insurance-claims': { title: 'Church, Nonprofit, and Religious Institution Insurance Claims: Irreplaceable Property, Volunteer Liability, and the Abuse Exclusion', description: 'Churches and nonprofits face insurance challenges no other policyholder encounters: irreplaceable stained glass, the abuse exclusion, volunteer injury gaps, historic code compliance nightmares, and donated property valuation.' },
  'gym-fitness-center-insurance-claims': { title: 'Gym and Fitness Center Insurance Claims: Equipment, Membership Revenue, and the Floor That Costs More Than You Think', description: 'Gyms face unique insurance exposures: $500K+ in specialized equipment, membership revenue that vanishes during closure, flooring that costs $15-50/sqft, and massive tenant buildouts in leased space.' },
  'salon-spa-insurance-claims': { title: 'Salon and Spa Insurance Claims: Chemical Exposure, Professional Liability, and Equipment Worth More Than the Buildout', description: 'Salons and spas face insurance exposures most business owners never anticipate: the pollution exclusion applied to everyday chemicals, professional liability for treatments gone wrong, and laser equipment worth $150K each.' },
  'ecommerce-business-insurance-claims': { title: 'E-Commerce Business Insurance Claims: When Your Property Is Digital, Your Warehouse Is Rented, and Your Policy Wasn\'t Designed for This', description: 'E-commerce businesses fall through traditional insurance gaps: the home-based business exclusion, electronic data sublimits, off-premises inventory, and business income when your website goes down.' },
  'self-storage-facility-insurance-claims': { title: 'Self-Storage Facility Insurance Claims: Thousands of Customers, Unknown Contents, and the Documentation Nightmare', description: 'Self-storage facilities face unique insurance challenges from bailee coverage for thousands of customers\' property to climate-controlled unit failures, cascading water damage, and documenting unknown contents after a loss.' },
  'cause-and-origin-fire-investigations': { title: 'Cause and Origin Fire Investigations: What Policyholders Need to Know', description: 'A comprehensive guide to cause and origin (C&O) fire investigations in insurance claims. Covers the critical difference between fire department and insurance company investigators, policyholder rights, scene preservation, spoliation of evidence, NFPA 921 methodology, and how C&O findings can affect your claim.' },
  'wear-and-tear-exclusion': { title: 'The Wear and Tear Exclusion: When Insurance Companies Confuse Condition with Causation', description: 'The wear and tear exclusion is a cause of loss exclusion, not a condition exclusion. It excludes losses caused by wear and tear — not losses to property that happens to show wear and tear. Learn why condition is not causation and how to fight improper wear and tear denials.' },
  'subrogation-insurance-claims': { title: 'Subrogation in Insurance Claims: What Policyholders Need to Know', description: 'A comprehensive guide to subrogation in property insurance claims — the made whole doctrine, duty to cooperate, anti-subrogation rule, deductible recovery, and how subrogation investigations affect your claim timeline and settlement.' },
  'advance-payments-partial-payments': { title: 'Advance Payments and Partial Payments: Your Right to Money Before the Claim Is Resolved', description: 'Insurance companies used to issue generous advance payments as a strategic tool. Now they rarely pay anything until a precise amount is calculated. Learn what the law requires and how to demand timely payment.' },
  'insurer-option-to-repair': { title: 'The Insurer\'s Option to Repair: When the Carrier Wants to Fix It Instead of Pay You', description: 'Understanding the insurance carrier\'s contractual option to repair, rebuild, or replace damaged property instead of paying cash — what it means for policyholders, how carriers use it strategically, and how California law limits its abuse.' },
  'op-depreciation-california': { title: 'Can California Insurers Depreciate Overhead & Profit? No — Here\'s Why', description: 'California Insurance Code Section 2051(b) limits deductions to physical depreciation of structural components. O&P is a service cost that has no condition, no age, and cannot legally be depreciated.' },
  'selective-op-denial': { title: 'Selective O&P Denial: When Carriers Pay It on Some Trades But Not Others', description: 'Insurance companies routinely apply overhead and profit to some portions of a claim while excluding others — denying it on roofing, mitigation, or contents. The case law, the Xactimate mechanics, and how to fight back.' },
  'managing-agent-punitive-damages': { title: 'How to Plead and Prove Managing Agent Liability in California Insurance Bad Faith Cases', description: 'Punitive damages in insurance bad faith require conduct by an officer, director, or managing agent. Learn the White v. Ultramar test, discovery strategies for identifying the managing agent, the ratification doctrine, and how to defeat common carrier defenses.' },
  'standard-fire-policy-insurance-code-2070': { title: 'California\'s Standard Fire Policy: What Insurance Code 2070 Actually Says and Why It Matters', description: 'Insurance Code 2070 establishes the standard fire policy as a statutory floor for every fire insurance policy in California. A line-by-line walkthrough of key provisions, appraisal clause deviations, FAIR Plan broker liability differences, and how courts use deviations to protect policyholders.' },
  'repair-first-or-negotiate-first': { title: 'Repair First or Negotiate First: The Strategic Dilemma at the Heart of Every Property Insurance Claim', description: 'Should you complete repairs and present invoices, or negotiate the settlement before starting work? The strategic advantages, risks, and California-specific regulations that drive this critical decision.' },
  'unexpected-fire-causes-subrogation': { title: 'When Fires Start Themselves: Unexpected Ignition Sources, Misdiagnosed Origins & Subrogation', description: 'Crystal doorknobs, oily rags, pyrolysis, defective panels, recalled vehicles — unexpected fire causes that get misdiagnosed and the subrogation claims your insurer may be ignoring.' },
...
const ARTICLE_CONTENT: Record<string, () => Promise<{ meta: { title: string; description: string }; default: React.ComponentType }>> = {
  ...
  'biohazard-hazmat-trauma-cleanup': () => import('@/lib/content/articles/biohazard-hazmat-trauma-cleanup'),
  'unattended-death-claims': () => import('@/lib/content/articles/unattended-death-claims'),
  ...
  'proof-of-loss-signing-strategy': () => import('@/lib/content/articles/proof-of-loss-signing-strategy'),
  'carrier-contractor-admits-failure': () => import('@/lib/content/articles/carrier-contractor-admits-failure'),
  'insurer-directed-failed-repairs-wasted-policy-limits': () => import('@/lib/content/articles/insurer-directed-failed-repairs-wasted-policy-limits'),
  ...
  'supplement-process-insurance-claims': () => import('@/lib/content/articles/supplement-process-insurance-claims'),
  'labor-depreciation-debate': () => import('@/lib/content/articles/labor-depreciation-debate'),
  'xactimate-line-item-manipulation': () => import('@/lib/content/articles/xactimate-line-item-manipulation'),
  'how-to-read-xactimate-estimate': () => import('@/lib/content/articles/how-to-read-xactimate-estimate'),
  'emergency-mitigation-vendors': () => import('@/lib/content/articles/emergency-mitigation-vendors'),
  'insurance-ai-automated-claims': () => import('@/lib/content/articles/insurance-ai-automated-claims'),
  ...
  'delay-deny-defend-review': () => import('@/lib/content/articles/delay-deny-defend-review'),
  'good-hands-boxing-gloves-review': () => import('@/lib/content/articles/good-hands-boxing-gloves-review'),
  'ab-1642-claims-timeline': () => import('@/lib/content/articles/ab-1642-claims-timeline'),
  'advance-payments-insurance-claims': () => import('@/lib/content/articles/advance-payments-insurance-claims'),
  'back-to-back-disasters': () => import('@/lib/content/articles/back-to-back-disasters'),
  'below-the-deductible-strategies': () => import('@/lib/content/articles/below-the-deductible-strategies'),
  'blanket-vs-scheduled-personal-property': () => import('@/lib/content/articles/blanket-vs-scheduled-personal-property'),
  'builders-risk-insurance-claims': () => import('@/lib/content/articles/builders-risk-insurance-claims'),
  'certificates-of-insurance-limitations': () => import('@/lib/content/articles/certificates-of-insurance-limitations'),
  'commercial-crime-social-engineering': () => import('@/lib/content/articles/commercial-crime-social-engineering'),
  'depublication-hidden-insurance-law': () => import('@/lib/content/articles/depublication-hidden-insurance-law'),
  'false-fraud-accusations-claims': () => import('@/lib/content/articles/false-fraud-accusations-claims'),
  'farmers-closing-ratio': () => import('@/lib/content/articles/farmers-closing-ratio'),
  'fire-debris-cleanup-without-fire': () => import('@/lib/content/articles/fire-debris-cleanup-without-fire'),
  'fortuity-doctrine-insurance': () => import('@/lib/content/articles/fortuity-doctrine-insurance'),
  'frozen-pipe-water-damage-claims': () => import('@/lib/content/articles/frozen-pipe-water-damage-claims'),
  'insurer-antitrust-fair-plan': () => import('@/lib/content/articles/insurer-antitrust-fair-plan'),
  'insurer-insolvency-guaranty-fund': () => import('@/lib/content/articles/insurer-insolvency-guaranty-fund'),
  'insurer-reformation-policy': () => import('@/lib/content/articles/insurer-reformation-policy'),
  'multiple-insurers-same-loss': () => import('@/lib/content/articles/multiple-insurers-same-loss'),
  'osha-building-code-ordinance-coverage': () => import('@/lib/content/articles/osha-building-code-ordinance-coverage'),
  'property-held-in-trust-coverage': () => import('@/lib/content/articles/property-held-in-trust-coverage'),
  'reserve-reinsurance-discovery': () => import('@/lib/content/articles/reserve-reinsurance-discovery'),
  'state-farm-appraisal-trap': () => import('@/lib/content/articles/state-farm-appraisal-trap'),
  'systematic-underinsurance-class-actions': () => import('@/lib/content/articles/systematic-underinsurance-class-actions'),
  'trade-secret-claims-manuals': () => import('@/lib/content/articles/trade-secret-claims-manuals'),
  'underground-climate-change-subsidence': () => import('@/lib/content/articles/underground-climate-change-subsidence'),
  'underinsurance-broker-liability': () => import('@/lib/content/articles/underinsurance-broker-liability'),
  'virtual-inspections-remote-adjusting': () => import('@/lib/content/articles/virtual-inspections-remote-adjusting'),
  'wildfire-smoke-physical-loss': () => import('@/lib/content/articles/wildfire-smoke-physical-loss'),
  ...
  'hotel-hospitality-insurance-claims': () => import('@/lib/content/articles/hotel-hospitality-insurance-claims'),
  'auto-repair-body-shop-insurance-claims': () => import('@/lib/content/articles/auto-repair-body-shop-insurance-claims'),
  'warehouse-distribution-insurance-claims': () => import('@/lib/content/articles/warehouse-distribution-insurance-claims'),
  'construction-company-insurance-claims': () => import('@/lib/content/articles/construction-company-insurance-claims'),
  'professional-services-insurance-claims': () => import('@/lib/content/articles/professional-services-insurance-claims'),
  'extended-period-of-indemnity': () => import('@/lib/content/articles/extended-period-of-indemnity'),
  'dependent-property-business-income': () => import('@/lib/content/articles/dependent-property-business-income'),
  'ordinance-law-asbestos-abatement': () => import('@/lib/content/articles/ordinance-law-asbestos-abatement'),
  'commercial-lease-insurance-checklist': () => import('@/lib/content/articles/commercial-lease-insurance-checklist'),
  'landlord-insurance-should-have-covered': () => import('@/lib/content/articles/landlord-insurance-should-have-covered'),
  'climate-change-commercial-property-insurance': () => import('@/lib/content/articles/climate-change-commercial-property-insurance'),
  'parametric-insurance-commercial': () => import('@/lib/content/articles/parametric-insurance-commercial'),
  'commercial-umbrella-excess-liability': () => import('@/lib/content/articles/commercial-umbrella-excess-liability'),
  'business-cyber-liability-insurance': () => import('@/lib/content/articles/business-cyber-liability-insurance'),
  'daycare-childcare-insurance-claims': () => import('@/lib/content/articles/daycare-childcare-insurance-claims'),
  'coworking-space-insurance-claims': () => import('@/lib/content/articles/coworking-space-insurance-claims'),
  'food-truck-mobile-vendor-insurance-claims': () => import('@/lib/content/articles/food-truck-mobile-vendor-insurance-claims'),
  'manufacturing-industrial-insurance-claims': () => import('@/lib/content/articles/manufacturing-industrial-insurance-claims'),
  'church-nonprofit-insurance-claims': () => import('@/lib/content/articles/church-nonprofit-insurance-claims'),
  'gym-fitness-center-insurance-claims': () => import('@/lib/content/articles/gym-fitness-center-insurance-claims'),
  'salon-spa-insurance-claims': () => import('@/lib/content/articles/salon-spa-insurance-claims'),
  'ecommerce-business-insurance-claims': () => import('@/lib/content/articles/ecommerce-business-insurance-claims'),
  'self-storage-facility-insurance-claims': () => import('@/lib/content/articles/self-storage-facility-insurance-claims'),
  'cause-and-origin-fire-investigations': () => import('@/lib/content/articles/cause-and-origin-fire-investigations'),
  'wear-and-tear-exclusion': () => import('@/lib/content/articles/wear-and-tear-exclusion'),
  'subrogation-insurance-claims': () => import('@/lib/content/articles/subrogation-insurance-claims'),
  'advance-payments-partial-payments': () => import('@/lib/content/articles/advance-payments-partial-payments'),
  'insurer-option-to-repair': () => import('@/lib/content/articles/insurer-option-to-repair'),
  'op-depreciation-california': () => import('@/lib/content/articles/op-depreciation-california'),
  'selective-op-denial': () => import('@/lib/content/articles/selective-op-denial'),
  'managing-agent-punitive-damages': () => import('@/lib/content/articles/managing-agent-punitive-damages'),
  'standard-fire-policy-insurance-code-2070': () => import('@/lib/content/articles/standard-fire-policy-insurance-code-2070'),
  'repair-first-or-negotiate-first': () => import('@/lib/content/articles/repair-first-or-negotiate-first'),
  'unexpected-fire-causes-subrogation': () => import('@/lib/content/articles/unexpected-fire-causes-subrogation'),
  'stock-inventory-valuation-methods': () => import('@/lib/content/articles/stock-inventory-valuation-methods'),
  'business-income-loss-calculation': () => import('@/lib/content/articles/business-income-loss-calculation'),
