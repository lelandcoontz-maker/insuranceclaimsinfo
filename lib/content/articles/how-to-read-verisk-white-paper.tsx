...
export default function Content() {
  return (
    <>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        Verisk publishes a library of white papers, technical bulletins, and methodology documents through its Property Estimating Solutions division. These documents are available through the Verisk website at <a href="https://www.verisk.com" target="_blank" rel="noopener noreferrer" className="text-[#2E74B5] underline">verisk.com</a>, through the Xactware eService Center at <a href="https://veriskpropertyestimatingsolutions.my.site.com/s/" target="_blank" rel="noopener noreferrer" className="text-[#2E74B5] underline">eservice.xactware.com</a>, and through various industry channels. Key publications include:
      </p>
      ...
      <ol className="list-decimal pl-6 space-y-2 text-gray-700 mb-6">
        <li>
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700 mt-2">
            <li>O&amp;P White Paper: <a href="https://www.verisk.com/49d21b/siteassets/media/downloads/property-estimating/overhead-and-profit.pdf" target="_blank" rel="noopener noreferrer" className="text-[#2E74B5] underline">verisk.com/siteassets/media/downloads/property-estimating/overhead-and-profit.pdf</a></li>
            <li>Labor Efficiencies Design: <a href="https://www.verisk.com/49baf6/siteassets/media/downloads/property-estimating/labor-efficiencies-design.pdf" target="_blank" rel="noopener noreferrer" className="text-[#2E74B5] underline">verisk.com/siteassets/media/downloads/property-estimating/labor-efficiencies-design.pdf</a></li>
            <li>Labor Productivity: <a href="https://www.verisk.com/49d1ea/siteassets/media/downloads/property-estimating/labor-productivity-in-xactimate-pricing.pdf" target="_blank" rel="noopener noreferrer" className="text-[#2E74B5] underline">verisk.com/siteassets/media/downloads/property-estimating/labor-productivity-in-xactimate-pricing.pdf</a></li>
            <li>Pricing Research Methodology: <a href="https://www.verisk.com/49c07f/siteassets/media/downloads/property-estimating/pricing-research-methodology.pdf" target="_blank" rel="noopener noreferrer" className="text-[#2E74B5] underline">verisk.com/siteassets/media/downloads/property-estimating/pricing-research-methodology.pdf</a></li>
          </ul>
        </li>
        <li><strong>Xactware eService Center</strong>: The eService Center at <a href="https://veriskpropertyestimatingsolutions.my.site.com/s/" target="_blank" rel="noopener noreferrer" className="text-[#2E74B5] underline">eservice.xactware.com</a> hosts copies of white papers and technical documents, often organized by publication year.</li>
