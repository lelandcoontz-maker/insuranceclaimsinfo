...
export const meta = {
  ...
  description:
    'When property ownership is non-standard — a Medicaid/Medi-Cal recipient on the title, a life estate, probate-pending status, inherited property — coverage defenses multiply and authority over the claim gets murky. The guide to navigating the intersection of property ownership, estate law, and California insurance claims.',
  summary:
