...
export default function Content() {
  return (
    <>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        In <em>Colonial Life</em>, the policyholder (Louise Perry) sued Colonial Life and its
        claims adjusters &mdash; Equifax Inc. and J. T. Sharkey &mdash; for violation of
        Insurance Code &sect; 790.03(h), breach of contract, and breach of the implied
        covenant of good faith and fair dealing. She sought discovery of the names, addresses,
        and records of approximately 35 other claimants whose claims were assigned to Sharkey
        for settlement, to establish a pattern of unfair settlement practices. Colonial
        resisted, arguing that the information was irrelevant and that disclosing other
        insureds&rsquo; information would violate their privacy.
      </p>
      <p className="text-gray-700 leading-relaxed mb-4">
