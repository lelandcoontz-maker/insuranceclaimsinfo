  ...
  return (
    <>
      ...
      <blockquote className="border-l-4 border-[#C9A84C] pl-4 italic text-gray-600 mb-6">
        ...
        umpire, then, on request of the insured or this company, the umpire shall be selected by
        a judge of a court of record in the state in which the property covered is located. The
        ...
        An award in writing, so itemized, of any two when filed with this company shall determine
        the amount of actual cash value and loss.&rdquo;
      </blockquote>
      <p className="text-gray-700 leading-relaxed mb-4">
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        <strong>Be proactive, not reactive.</strong> The carrier&rsquo;s appraiser will have a
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        ...
        they technically meet the statutory requirements. Push for candidates with no significant
      ...
      <CalloutBox variant="tip" title="When in Doubt, Go to Court">
        <p>
          ...
          &mdash; do not capitulate. Let the 15-day window expire and petition the court to
      ...
      <ol className="list-decimal pl-6 space-y-2 text-gray-700 mb-6">
        <li>
          <strong>Corruption, fraud, or other undue means:</strong> The award was procured
          through dishonest conduct &mdash; for example, one party bribing the umpire or
          fabricating evidence.
        </li>
        <li>
          <strong>Corruption or evident partiality of the umpire:</strong> The umpire was biased
          toward one party. Under <em>Sharma</em>, failure to make required disclosures under
          CCP &sect; 1281.9 can establish evident partiality even without proof of actual bias.
        </li>
        <li>
          <strong>Misconduct substantially prejudicing a party&rsquo;s rights:</strong> The
          panel engaged in procedural irregularities that materially affected the outcome &mdash;
          for example, ex parte contact between the umpire and one appraiser, or refusing to
          allow one side to present its evidence.
        </li>
        <li>
          <strong>The panel exceeded its powers:</strong> The panel decided issues beyond its
          authority &mdash; for example, making coverage determinations in violation of{' '}
          <em>Kacha</em>, or issuing an award that was not properly itemized as required by
          &sect; 2071.
        </li>
        <li>
          <strong>The panel&rsquo;s refusal to hear material evidence:</strong> A party was
          denied the opportunity to present evidence that was relevant to the amount of loss.
          This can include the umpire refusing to inspect the property, refusing to review the
          appraiser&rsquo;s submissions, or refusing to meet with the appraisers.
        </li>
      </ol>
      <p className="text-gray-700 leading-relaxed mb-4">
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <Link href="/resources/bad-faith" className="text-[#2E74B5] underline">
          bad faith
        </Link>. The award has eliminated any genuine dispute about the amount of loss. Once that
        amount is determined, the insurer&rsquo;s continued failure to pay has no reasonable
        basis &mdash; and under California&rsquo;s{' '}
        <em>Genuine Dispute</em> doctrine, the absence of a reasonable basis for withholding
        benefits is precisely what creates bad faith liability. Document the delay
        meticulously: when the award was issued, when and how it was served on the insurer,
        what payment demands were made, and every communication (or lack thereof) from the
        insurer following the award.
      </p>

      <CalloutBox variant="warning" title="The 100-Day Window Applies to Both Sides">
        <p>
          The insurer has 100 days from service of the award to file a petition to vacate under
          CCP &sect; 1288. If the insurer does not file within that window, the award is final
          and cannot be challenged. Monitor this deadline carefully. Once it passes without a
          petition from the insurer, confirm the award immediately and pursue collection. At that
          point, the insurer has no remaining legal basis to withhold payment, and any further
          delay strengthens the case for bad faith.
        </p>
      </CalloutBox>
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
        <li>
          ...
          policyholder waits. Counter this by documenting the obstruction and moving to court
        ...
        <li>
          ...
          that the panel can and should evaluate. Push back on any attempt to remove legitimately
        ...
        <li>
          ...
          software may accept these manipulated figures at face value. Your appraiser needs to
          identify and document every deviation from fair pricing in the carrier&rsquo;s estimate.
        </li>
        <li>
          ...
          statutory requirement that each appraiser independently appraise the loss. Insist on
