  ...
  return (
    <>
      ...
      <CalloutBox variant="warning" title="$19,000 vs. $5,000 &mdash; Same Claim, Same Invoice">
        <p>
          The difference between proper and improper cost allocation on this single claim is <strong>$14,000</strong>. The remediation work is identical. The invoice is identical. The only difference is whether the insurer correctly allocates water mitigation costs to dwelling coverage or incorrectly dumps everything under the mold sublimit. As Insurance.com has noted, &ldquo;tracking and separating costs between water damage and mold remediation is crucial to ensuring the claim is properly paid.&rdquo; This is not aggressive advocacy &mdash; it is the correct reading of the policy.
        </p>
      </CalloutBox>
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
        <li><strong>New Jersey:</strong> Requires carriers to offer mold coverage as part of the homeowner policy. Policyholders can decline it, but it must be offered.</li>
        <li><strong>Texas:</strong> After the massive mold litigation wave of the early 2000s, Texas requires carriers to offer mold coverage options but allows them to set sublimits. The Texas Department of Insurance has established minimum mold coverage amounts that must be offered, typically starting at $5,000.</li>
        <li><strong>California:</strong> The California Department of Insurance (CDI) has issued bulletins directing insurers to provide mold coverage options and to clearly disclose mold sublimits on the declarations page. California&rsquo;s regulatory minimum for mold coverage, where offered, is typically $5,000, though many carriers offer endorsements to increase this amount to $10,000, $25,000, or higher.</li>
      </ul>
      <p className="text-gray-700 leading-relaxed mb-4">
