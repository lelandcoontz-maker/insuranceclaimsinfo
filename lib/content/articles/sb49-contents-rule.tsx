...
export const meta = {
  ...
  summary:
    'SB 495 changes contents claims after declared disasters: insurers must pay a substantial automatic percentage of contents (around 60%) without requiring an itemized inventory for a set period. It speeds recovery for disaster victims; use it.',
}
