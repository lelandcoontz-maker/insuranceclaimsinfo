  ...
  return (
    <>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        ...
        don&apos;t need all seven. You need one. So stop fighting over reason #3 when reasons #1,
        #2, and #4 through #7 are sitting right there, unused.
      </p>

      <CalloutBox variant="important" title="Don&apos;t Get Stuck in a Mental Canyon">
        <p>
          ...
          integrity, whether a particular standard applies. While you&apos;re arguing one point,
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        ...
        baseboards. The baseboards got wet. Should the insurance company pay to replace them? Let&apos;s
        count the reasons.
      </p>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        ...
        baseboard that won&apos;t stay attached to the wall is not functional. Note that this is a
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        ...
        If the replacement baseboards don&apos;t match the surviving ones, matching requires
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-6">
        ...
        <ol className="list-decimal pl-6 space-y-1 text-gray-700">
          ...
          <li>Matching (can&apos;t match the ones already replaced)</li>
        </ol>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        Early in my career, a very sharp Public Adjuster called me with a dilemma. He was
        ...
        a standard, they said, they couldn&apos;t determine whether the couch was &ldquo;really&rdquo;
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        ...
        — what&apos;s the threshold? Which lab test? What standard applies? It had become an esoteric
      ...
      <CalloutBox variant="tip" title="When You&apos;re Stuck, Pivot">
        <p>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        ...
        pushes back — &ldquo;the sheathing looks fine,&rdquo; &ldquo;it&apos;s been re-roofed
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        ...
        (also called code upgrade coverage). Here&apos;s why:
      </p>
      <p className="text-gray-700 leading-relaxed mb-4">
        ...
        (e.g., 15/32&rdquo; or 1/2&rdquo; plywood) that the existing sheathing doesn&apos;t meet.
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        ...
        (Coverage A) or your other structures limit (Coverage B). If you&apos;ve exhausted the
      ...
      <ol className="list-decimal pl-6 space-y-3 text-gray-700 mb-6">
        <li>
          <strong>List every reason the item needs to be repaired or replaced.</strong> Don&apos;t
        ...
        <li>
          ...
          Don&apos;t let the adjuster collapse all your arguments into one.
        </li>
        <li>
          <strong>Lead with the strongest, simplest argument.</strong> If the baseboard is visibly
          swollen and deformed, start there. Don&apos;t lead with the contamination argument that
          requires lab testing when you have a physical deformation that is visible to the naked eye.
        </li>
        <li>
          <strong>Pivot when you&apos;re stuck.</strong> If you&apos;ve been arguing about
          contamination standards for three weeks and the adjuster won&apos;t budge, change the
          subject. Bring up the odor. Bring up the staining. Bring up the need to remove it for
          drying. Don&apos;t ride one argument into the ground when you have alternatives.
        </li>
        <li>
      ...
      <ol className="list-decimal pl-6 space-y-2 text-gray-700 mb-6">
        ...
        <li>
          <strong>Matching</strong> — the item doesn&apos;t match what has already been replaced.
        ...
        <li>
          <strong>Code compliance (Law and Ordinance)</strong> — the item doesn&apos;t meet
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        ...
        damage argument that doesn&apos;t.
      </p>

      <CalloutBox variant="tip" title="Whatever Gets It Paid">
        <p>
          Don&apos;t fall in love with one argument. The goal is to get the item paid for at a
