  ...
  return (
    <>
      ...
      <CalloutBox variant="warning" title="Construction Defects Have Their Own Remedies">
        <p>
          If your stucco failure is truly a construction defect, you may have remedies outside your insurance policy. California&rsquo;s Right to Repair Act (Civil Code &sect;&sect; 895&ndash;945.5) establishes a prelitigation process for residential construction defect claims against the builder. The California Supreme Court held in <em>McMillin Albany LLC v. Superior Court</em> (2018) 4 Cal.5th 241 that this statutory scheme is the exclusive remedy for covered defect claims against builders, displacing common-law construction-defect theories within its scope. The statute of limitations for construction defect claims under the Right to Repair Act is separate from your insurance claim deadlines, and the existence of an SB 800 cause of action against the builder does not by itself foreclose ensuing-loss or efficient-proximate-cause coverage arguments against the carrier for separate water-damage harm. See <Link href="/resources/construction-defect-claims" className="text-[#2E74B5] underline">Construction Defects and Insurance Claims</Link> for a detailed explanation.
        </p>
      </CalloutBox>
