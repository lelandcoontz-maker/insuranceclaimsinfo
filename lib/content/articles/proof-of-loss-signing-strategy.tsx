...
export const meta = {
  title: "Proof of Loss: What You Are Really Signing",
  description: "A proof of loss is a sworn statement that can lock you into the carrier's numbers. How to modify the form, use partial proofs, and protect coverage.",
  summary:
