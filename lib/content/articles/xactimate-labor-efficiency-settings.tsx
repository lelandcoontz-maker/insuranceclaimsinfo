...
export const meta = {
  ...
  description:
    "A comprehensive guide on how Xactimate's labor efficiency settings affect every labor line item in an insurance estimate and how the wrong setting can systematically underpay an entire claim by thousands of dollars.",
}
