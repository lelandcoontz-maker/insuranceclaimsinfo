...
export default function Content() {
  return (
    <>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        Each of these scenarios creates what insurance professionals call <strong>overlapping claims</strong> &mdash; two separate loss events affecting the same property, often interacting with each other in ways that make damage attribution extraordinarily difficult. For insurers, overlapping claims present opportunities to minimize exposure by shifting damage from one event to another, arguing about pre-existing conditions, and exploiting the confusion that multiple claims create. For policyholders, overlapping claims are a nightmare of documentation, bureaucracy, and coverage disputes layered on top of an already devastating situation.
      </p>
      <p className="text-gray-700 leading-relaxed mb-4">
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        ...
        . Under California Insurance Code &sect;530 and the California Supreme Court&rsquo;s decisions in <em>Garvey v. State Farm</em> (1989) 48 Cal.3d 395 and <em>Julian v. Hartford Underwriters</em> (2005) 35 Cal.4th 747, the question is always: what was the predominating cause that set the chain of events in motion?
      </p>
      <p className="text-gray-700 leading-relaxed mb-4">
