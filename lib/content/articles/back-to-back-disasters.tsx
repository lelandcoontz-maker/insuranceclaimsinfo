...
export default function Content() {
  return (
    <>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        Each of these scenarios creates what insurance professionals call <strong>overlapping claims</strong> &mdash; two separate loss events affecting the same property, often interacting with each other in ways that make damage attribution highly difficult. For insurers, overlapping claims present opportunities to minimize exposure by shifting damage from one event to another, arguing about pre-existing conditions, and exploiting the confusion that multiple claims create. For policyholders, overlapping claims are a nightmare of documentation, bureaucracy, and coverage disputes layered on top of an already devastating situation.
      </p>
      <p className="text-gray-700 leading-relaxed mb-4">
