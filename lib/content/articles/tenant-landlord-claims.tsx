...
export default function Content() {
  return (
    <>
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
        <li><strong>Personal property</strong> &mdash; furniture, clothing, electronics, kitchenware, and everything the tenant owns</li>
        ...
        <li><strong>Personal liability</strong> &mdash; if the tenant causes damage to the building or injures someone</li>
      </ul>
      <p className="text-gray-700 leading-relaxed mb-4">
