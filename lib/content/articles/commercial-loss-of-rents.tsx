...
export const meta = {
  title: "Commercial Loss of Rents Coverage for Landlords",
  description:
...
export default function Content() {
  return (
    <>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        Commercial loss of rents coverage &mdash; sometimes called &ldquo;rental value coverage&rdquo; or &ldquo;rental income coverage&rdquo; in commercial property forms &mdash; pays the landlord for the fair rental value of the damaged portions of the property during the period of restoration. Under the ISO Business Income (And Extra Expense) Coverage Form (CP 00 30), the definition of &ldquo;Business Income&rdquo; expressly includes &ldquo;Rental Value&rdquo; when the insured is a property owner who derives income from renting the property to others. The Building and Personal Property Coverage Form (CP 00 10) covers the structure itself; the loss-of-rents protection comes from CP 00 30 (or the no-extra-expense variant CP 00 32), which is added with its own limit and conditions.
      </p>
      <p className="text-gray-700 leading-relaxed mb-4">
