...
export default function Content() {
  return (
    <>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        California Insurance Code &sect; 2051(b)(2) defines the measure of recovery for a partial loss as &ldquo;the amount it would cost the insured to repair, rebuild, or replace the damaged or destroyed property, less a fair and reasonable deduction for physical depreciation based upon its condition at the time of the injury or the policy limit, whichever is less.&rdquo; (The phrase &ldquo;damaged or destroyed property&rdquo; replaced the prior &ldquo;thing lost or injured&rdquo; via AB 188, Stats. 2019, ch. 59, effective January 1, 2020.) That statutory language &mdash; &ldquo;would cost the insured&rdquo; &mdash; is present tense and practical. It refers to the actual cost the policyholder faces, not a hypothetical cost derived from a pre-event pricing database. When demand surge has increased the cost of construction, the cost the insured faces is the surged cost. The carrier&apos;s obligation adjusts accordingly.
      </p>
