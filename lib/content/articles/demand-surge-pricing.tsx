...
export default function Content() {
  return (
    <>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        California Insurance Code &sect; 2051 defines the measure of recovery as &ldquo;the amount it would cost the insured to repair, rebuild, or replace the thing lost or injured.&rdquo; That statutory language &mdash; &ldquo;would cost the insured&rdquo; &mdash; is present tense and practical. It refers to the actual cost the policyholder faces, not a hypothetical cost derived from a pre-event pricing database. When demand surge has increased the cost of construction, the cost the insured faces is the surged cost. The carrier&apos;s obligation adjusts accordingly.
      </p>
