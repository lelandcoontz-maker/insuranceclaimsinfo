  ...
  return (
    <>
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
        ...
        <li>
          <strong>Large claim amount.</strong> Many carriers have automatic SIU referral thresholds based on claim size. A claim exceeding a certain dollar amount &mdash; whether $50,000, $100,000, or some other internal threshold &mdash; may be automatically flagged regardless of any other factor. This is perhaps the most telling trigger: it has nothing to do with indicators of fraud and everything to do with the financial exposure the carrier faces.
        </li>
        <li>
