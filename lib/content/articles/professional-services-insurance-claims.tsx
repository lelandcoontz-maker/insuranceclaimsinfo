...
export default function Content() {
  return (
    <>
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
        <li><strong>California State Bar (attorneys).</strong> California Rule of Professional Conduct 1.16(e) requires attorneys, upon termination of representation, to take reasonable steps to protect a client&rsquo;s interests &mdash; including giving reasonable notice, allowing time for the client to employ other counsel, surrendering papers and property the client is entitled to, and refunding unearned fees. The rule itself does not impose a specific file-retention period. Separately, State Bar guidance (not a rule mandate) recommends retaining closed files for at least five years, with longer retention recommended for certain categories such as estate planning, real property, and matters involving minors. Destruction of client files by a covered peril should still be documented and disclosed to affected clients.</li>
