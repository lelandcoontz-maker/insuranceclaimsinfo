  ...
  return (
    <>
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
        ...
        <li><strong>California Architects Board.</strong> California Business and Professions Code &sect;5536.22 requires architects to maintain records of their professional activities. Project files, including drawings, specifications, and correspondence, should be maintained for at least 10 years after project completion &mdash; the statute of repose for construction defect claims in California (CCP &sect;337.15).</li>
      </ul>
      <p className="text-gray-700 leading-relaxed mb-4">
