...
export const meta = {
  title: "Mudslide After Wildfire: Coverage in California",
  description:
  ...
  return (
    <>
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
        ...
        <li>
          <strong><em>Howell v. State Farm Fire &amp; Cas. Co.</em> (1990) 218 Cal.App.3d 1446:</strong> The California Court of Appeal applied <em>Sabella</em> and <em>Garvey</em> to facts that are directly on point for this article. Barbara Howell owned a 17-acre parcel in Lafayette with a home, rental units, and a commercial kennel. In summer 1985 a fire destroyed much of the vegetation on the slope above the property; the following winter, unusually heavy rains drenched the denuded slope, and a major landslide damaged the property. State Farm denied under the earth movement and water exclusions. The Court of Appeal held that anti-concurrent-causation policy language cannot defeat coverage where a covered peril (the wildfire) was the efficient proximate cause, even when an excluded peril (earth movement) was the immediate physical cause of damage. <em>Howell</em> is the controlling California Court of Appeal authority for the post-wildfire mudslide / landslide pattern.
        </li>
        <li>
        ...
        <li>
          <strong>California Insurance Code &sect; 530.5</strong> (added 2018, effective Jan. 1, 2019): Enacted by the Legislature after the Montecito debris flows. The statute addresses any concurrent-peril claim where one of the perils is a landslide, mudslide, mudflow, or debris flow &mdash; providing that coverage applies if an insured peril (such as wildfire) is the efficient proximate cause and coverage would otherwise be provided for the insured peril. The framing is debris-flow-side rather than wildfire-side, but the practical effect is to protect post-wildfire mudslide claims when wildfire is the efficient proximate cause.
        </li>
        <li>
