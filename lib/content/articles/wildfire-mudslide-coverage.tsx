  ...
  return (
    <>
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
        ...
        <li>
          <strong><em>Howell v. State Farm Fire &amp; Cas. Co.</em> (1990) 218 Cal.App.3d 1446:</strong> The California Court of Appeal directly applied <em>Sabella</em> and <em>Garvey</em> to a fire loss with subsequent earth-movement/settling damage. The court held that anti-concurrent-causation policy language cannot defeat coverage where a covered peril (fire) was the efficient proximate cause, even when an excluded peril (earth movement) was part of the causal chain. While the <em>Howell</em> facts involved post-fire structural settling rather than the specific &ldquo;burn-scar hillside followed by rain-induced mudslide&rdquo; sequence at issue here, the case&rsquo;s holding on ACC language and the efficient-proximate-cause analysis applies directly to the post-wildfire mudslide pattern.
        </li>
        <li>
