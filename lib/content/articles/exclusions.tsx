...
export default function Content() {
  return (
    <>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        <strong>Open-peril (all-risk) policies</strong> cover all causes of loss <em>unless</em> a specific exclusion removes coverage. The standard HO-3 Special Form homeowner policy is an open-peril policy for the dwelling and other structures. Under an open-peril policy, the policyholder does not need to prove that a specific covered peril caused the loss. The policyholder needs only to show that a loss occurred. The burden then shifts to the insurer to prove that a specific exclusion applies and bars coverage.
      </p>
      <p className="text-gray-700 leading-relaxed mb-4">
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        Under an open-peril policy, the allocation of the burden of proof is critical &mdash; and it favors the policyholder. The California Supreme Court articulated the framework in <em>Aydin Corp. v. First State Ins. Co.</em> (1998) 18 Cal.4th 1183 and applied it in subsequent cases including <em>MacKinnon v. Truck Insurance Exchange</em> (2003) 31 Cal.4th 635:
      </p>
