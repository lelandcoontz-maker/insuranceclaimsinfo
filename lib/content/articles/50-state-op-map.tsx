...
export default function Content() {
  return (
    <>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        While the regulation does not explicitly mandate O&amp;P by name, it requires estimates reflecting the actual cost to restore property &mdash; which implicitly includes O&amp;P when a general contractor would be needed. The California Supreme Court in <em>Jefferson</em> adopted the broad evidence rule for ACV, holding that ACV does not simply mean replacement cost less depreciation.
      </p>
      <p className="text-gray-700 leading-relaxed mb-4 text-sm italic">
