  ...
  return (
    <>
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
        ...
        <li>
          <strong>SB 800 standards &mdash; Civil Code &sect;&sect; 896, 941:</strong> The Right to Repair Act has its own framework. Section 896 sets the construction standards and provides shorter component-specific limits for several categories measured from close of escrow &mdash; for example, plumbing and sewer (four years, &sect; 896(e)), electrical (four years, &sect; 896(f)), paint and stains (five years, &sect; 896(g)(10)), and irrigation and drainage (one year, &sect; 896(g)(7)). For envelope water-intrusion claims (roofs, windows, exterior walls, foundations, etc.), &sect; 896 does not set its own shorter period; the controlling outside limit is the ten-year latent-defect window in CCP &sect; 337.15, incorporated through Civil Code &sect; 941. In short: identify which specific &sect; 896 sub-standard you are alleging, then apply the shorter period if one exists; otherwise the ten-year &sect; 941 / CCP &sect; 337.15 outside limit governs.
        </li>
      </ul>
