...
export const meta = {
  ...
  description:
    'A guide to identifying managing agents under Civil Code section 3294(b), the White v. Ultramar test, discovery strategies, ratification doctrine, and how managing agent liability creates settlement leverage in California insurance bad faith litigation.',
  summary:
