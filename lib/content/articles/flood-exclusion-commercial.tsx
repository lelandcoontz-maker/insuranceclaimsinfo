...
export const meta = {
  title: "The Flood Exclusion in Commercial Property Insurance",
  description:
...
export default function Content() {
  return (
    <>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        The standard ISO commercial property program pairs the Building and Personal Property Coverage Form (CP 00 10), which defines what property is covered, with a Causes of Loss form, which defines what perils are covered and excluded. On a Special Form policy, that Causes of Loss form is CP 10 30. CP 10 30 excludes loss caused by &ldquo;flood, surface water, waves (including tidal wave and tsunami), tides, tidal water, overflow of any body of water, or spray from any of these, all whether or not driven by wind.&rdquo; This is not a narrow exclusion. It captures virtually every scenario in which water that originated outdoors enters the insured premises at ground level or below.
      </p>
      <p className="text-gray-700 leading-relaxed mb-4">
        The exclusion appears in <strong>Section B &mdash; Exclusions</strong> of the Causes of Loss form (CP 10 30 on a Special Form policy; the parallel water exclusion appears in CP 10 10 Basic and CP 10 20 Broad), typically under the heading &ldquo;Water.&rdquo; In most editions, it is paired with several other water-related exclusions, including mudslide, mudflow, and water that backs up from a sewer or drain. Some editions combine these under a single exclusion number; others list them as sub-parts. Regardless of format, the combined effect is the same: if outdoor water entered your business at ground level or below, the standard commercial property policy does not cover the resulting damage.
      </p>
