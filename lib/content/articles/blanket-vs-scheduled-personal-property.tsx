    ...
    <>
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
        ...
        <li>
          ...
          depreciation. Under California Insurance Code &sect; 2051.5(b)(1)(A), policyholders
          have at least <strong>12 months</strong> from the date of the first ACV payment
          to collect the replacement cost holdback in standard losses, and under &sect;
          2051.5(b)(1)(B) at least <strong>36 months</strong> for losses related to a
          declared state of emergency (with additional six-month extensions available for
          good cause). Policyholders
